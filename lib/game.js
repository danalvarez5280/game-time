  ...
  checkCollisionWater() {
    ...
    var didILand = false;
      for (let j = 0; j < this.lanes[this.player.currentLane].moversInMyLane.length; j++) {
        let mover = this.lanes[this.player.currentLane].moversInMyLane[j];
        let frog = this.player;
...
// can't get this to run properly, ended up calling the if statment in the index
  zoneCheck() {
    ...
    if (this.player.y >= 50 && this.player.y < 300) {
  ...
  addMovers() {
    ...
    var start = new Lane('right', 0, 600);
    var median = new Lane('right', 0, 300);
    var end = new Lane('right', 0, 0);


    var road1 = new Lane('left', 0.3, 550);
    var road2 = new Lane('right', 0.3, 500);
    var road3 = new Lane('left', 0.3, 450);
    var road4 = new Lane('right', 0.3, 400);
    var road5 = new Lane('left', 0.3, 350);

    var agua1 = new Lane('right', 0.3, 250);
    var agua2 = new Lane('left', 0.3, 200);
    var agua3 = new Lane('right', 0.3, 150);
    var agua4 = new Lane('right', 0.3, 100);
    var agua5 = new Lane('right', 0.3, 50);


    var truck1 = new Mover(100, road1.y, 100, 50, 'red', false);
    var truck2 = new Mover(250, road1.y, 100, 50, 'red', false);
    var truck3 = new Mover(-100, road2.y, 100, 50, 'red', false);
    var truck4 = new Mover(-250, road2.y, 100, 50, 'red', false);
    var truck5 = new Mover(150, road3.y, 150, 50, 'purple', false);
    var truck6 = new Mover(350, road3.y, 150, 50, 'purple', false);
    var truck7 = new Mover(-100, road4.y, 50, 50, 'yellow', false);
    var truck8 = new Mover(-200, road4.y, 50, 50, 'yelllow', false);
    var truck9 = new Mover(100, road5.y, 50, 50, 'yellow', false);


    var log1 = new Mover(-450, agua1.y, 150, 50, 'brown', true);
    var log2 = new Mover(-150, agua1.y, 150, 50, 'brown', true);
    var log3 = new Mover(150, agua2.y, 100, 50, 'brown', true);
    var log4 = new Mover(300, agua2.y, 100, 50, 'brown', true);
    var log5 = new Mover(-100, agua3.y, 100, 50, 'brown', true);
    var log6 = new Mover(-300, agua3.y, 100, 50, 'brown', true);
    var log7 = new Mover(-100, agua4.y, 50, 50, 'brown', true);
    var log8 = new Mover(-200, agua4.y, 50, 50, 'brown', true);
    var log9 = new Mover(300, agua5.y, 50, 50, 'brown', true);
